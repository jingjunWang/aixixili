	...
	<body>
			 ...
			 <div class="weui-form-preview" id="head" >
	            ...
	            <div class="weui-form-preview__bd">
	                			<div class="weui-cell weui-cell_select weui-cell_select-after weui-cell_warn">
							       ...
							       <input id="orderKey" name="orderKey" class="weui-input weui-cell_warn" type="text" placeholder="订单号（必填） "  />
							      
							    </div>
							
							    <div class="weui-cell weui-cell_select weui-cell_select-after weui-cell_warn">
							        <div class="weui-cell__hd">
							            <label for="" class="weui-label">金额：</label>
							        </div>
							        <input id="money" name="money"  class="weui-input"   placeholder="金额（必填）" />
							      
							    </div>
							     <div class="weui-cell weui-cell_select weui-cell_select-after weui-cell_warn">
							        <div class="weui-cell__hd">
							            <label for="" class="weui-label">pos机号：</label>
							        </div>
							        <input id="posId" name="posId"  class="weui-input"   placeholder="pos机（必填）" />
							       
							    </div>
							     <div class="weui-cell weui-cell_select weui-cell_select-after weui-cell_warn">
							        <div class="weui-cell__hd">
							            <label for="" class="weui-label">门店号：</label>
							        </div>
							        <input id="storeId" name="storeId"  class="weui-input"   placeholder="门店号（必填）" />
						...
						<div class="weui-cells weui-cells_form">
							<form id="personal" name=personal method="post" action="">
							    ...
							    <div class="weui-cell weui-cell_select weui-cell_select-after weui-cell_warn">
							       ...
							       <input id="pemail" name="p_email" class="weui-input" type="text" placeholder="请输入您的邮箱 （必填）"  />
							        <div class="weui-cell__bd">
						...
						<form id="enterprise" name=enterprise method="post" action="">
							<div class="weui-cells">
								    ...
								    <div class="weui-cell weui-cell_select weui-cell_select-after weui-cell_warn">
								       ...
								       <input id="email" name="e_email" class="weui-input" type="text" placeholder="请输入您的邮箱 （必填）"  />
								        <div class="weui-cell__bd">
		...
		<script type="text/javascript">
			...
			function personalfun(){
				...
				if(posId == null || posId==""){
					document.getElementById("message").innerHTML="pos号不能为空";
					$dialog.fadeIn(100);
				}else
				if(storeId == null || storeId==""){
					document.getElementById("message").innerHTML="门店号不能为空";
					$dialog.fadeIn(100);
				}else
				if(money == null || money==""){
					document.getElementById("message").innerHTML="金额不能为空";
					$dialog.fadeIn(100);
				}else
				if(orderkey == null || orderkey==""){
					document.getElementById("message").innerHTML="订单号不能为空";
					$dialog.fadeIn(100);
				}else
			 ...
			 $.ajax({
						url:"${ctx}/weixin/personal2",
						type:"POST",
						//async: false,//取消异步
						dataType:"json",
						data:{p_name:pname,p_mphone:pphone,p_email:pemail,posId:posId,storeId:storeId,amount:money,orderkey:orderkey,openid:openid},
			...
			function enterprisefun(){
				...
				var eaddress = document.getElementById("e_address").value;
				var eaccount = document.getElementById("e_account").value;
				var ephone = document.getElementById("e_phone").value;
				var ebank = document.getElementById("e_bank").value;
				
				var posId = document.getElementById("posId").value;
				var storeId = document.getElementById("storeId").value;
				var money = document.getElementById("money").value;
				var orderkey = document.getElementById("orderKey").value;
				var openid = document.getElementById("eopenid").value;
				...
				if(!(/^1(3|4|5|7|8)\d{9}$/.test(emphone))){
				...
				$loadingToast.fadeIn(100);
					$.ajax({
						url:"${ctx}/weixin/enterprise2",
						type:"POST",
						//async: false,//取消异步
						dataType:"json",
						data:{e_name:ename,e_mphone:emphone,e_email:email,posId:posId,storeId:storeId,amount:money,orderkey:orderkey,openid:openid,e_number:sbh,
							e_phone:ephone,e_address:eaddress,e_bank:ebank,e_account:eaccount},
						success: function(data){

...
public class JSONutilss
{
     ...
     * @return
     */
    public static String toJSONStringArr(Object object)
    {
    ...
    public static HashMap toHashMap(Object object)
    {
        ...
        JSONObject jsonObject = JSONutilss.toJSONObject(object);
            ...
            String detailName, Class<D> detailClass)
    {
        ...
        T mainEntity = JSONutilss.toBean(jsonObject, mainClass);
        List<D> detailList = JSONutilss.toList(jsonArray, detailClass);
            ...
            Class<D2> detailClass2)
    {
        ...
        T mainEntity = JSONutilss.toBean(jsonObject, mainClass);
        List<D1> detailList1 = JSONutilss.toList(jsonArray1, detailClass1);
        List<D2> detailList2 = JSONutilss.toList(jsonArray2, detailClass2);
            ...
            Class<D3> detailClass3)
    {
        ...
        List<D1> detailList1 = JSONutilss.toList(jsonArray1, detailClass1);
        List<D2> detailList2 = JSONutilss.toList(jsonArray2, detailClass2);
        List<D3> detailList3 = JSONutilss.toList(jsonArray3, detailClass3);
